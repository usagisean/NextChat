...
const cn = {
  WIP: "该功能仍在开发中……",
  Error: {
    // 🔴 重点修改：报错时引导用户去你的网站注册，而不是去官方
    Unauthorized: `⚠️ **需要配置 API Key**
       \ 1️⃣ 还没有账号？[点击这里前往 ZX AI 注册获取](https://ai.zixiang.us/register?aff=onPD) 🚀
       \ 2️⃣ 获取 Key 后，点击[这里](/#/auth)输入访问密钥 🔑
       \ 3️⃣ 本站支持 GPT-4o、Claude-3.5、DeepSeek 等全模型支持。`,
  },
  Auth: {
    Return: "返回",
    Title: "需要密码",
    Tips: "管理员开启了密码验证，请在下方填入访问码",
    SubTips: "或者输入你在 ZX AI 获取的 API Key", // 🔴 修改：强调你的品牌
    Input: "在此处填写访问码或 API Key",
    Confirm: "确认",
    Later: "稍后再说",
    SaasTips: "还没有 API Key？", // 🔴 修改：引导注册
    TopTips:
      "🥳 ZX AI 限时优惠，注册即送额度，立刻解锁 GPT-4o, Claude-3.5, DeepSeek 等最新大模型", // 🔴 修改：你的广告位
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Access: {
      SaasStart: {
        ...
        Label: "（高性价比）",
        SubTitle:
          "由 ZX AI 强力驱动, 零配置开箱即用，支持 OpenAI o1, GPT-4o, DeepSeek 等最新大模型",
        ChatNow: "立刻对话",
      },
      AccessCode: {
        Title: "访问密码",
